...
# Run before: nb_03_metadata_pipeline_demo.py
...
# ---------------------------------------------------------------------------
# CELL 2 — dim_date  (2014-01-01 → 2026-12-31,  4748 rows)
# ---------------------------------------------------------------------------
import pandas as pd
...
# ---------------------------------------------------------------------------
# CELL 3 — dim_customer, dim_product, dim_service_account
# ---------------------------------------------------------------------------
spark.sql(f"""
...
# ---------------------------------------------------------------------------
# CELL 4 — dim_equipment  (with integer date keys + computed fields)
# ---------------------------------------------------------------------------
spark.sql(f"""
...
# ---------------------------------------------------------------------------
# CELL 7 — fct_contract_month  (contract × monthly spine, with IsNew / IsChurn)
# ---------------------------------------------------------------------------
spark.sql(f"""
...
print("\nStar schema ready.  Run nb_03_metadata_pipeline_demo.py next.")
